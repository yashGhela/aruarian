    ...
    return(
        ...
        <header>
         ...
         <main
          ...
          className=' flex self-center place-content-center bg-cover  bg-white text-center p-5 max-w-full min-w-screen  min-h-screen max-h-full overflow-hidden'>
     ...
     <div className=' md:w-[70rem] lg:w-[80rem] w-[40rem] mr-0 flex-col '>
        <div className="mt-[25%]">
                ...
                <svg aria-hidden="true" class="w-8 h-8 mr-2 text-white animate-spin dark:text-black fill-black" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
