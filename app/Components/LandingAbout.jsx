...
function LandingAbout() {
  return (
    ...
    <p className='text-2xl text-neutral-600 mt-2 font-semibold'>A message from the founder</p>
...
<p className=" text-left text-lg  lg:p-10"> 
     ...
     I created Ari because I hated every other productivity app, 

     They were all too manual and felt like I could've just used a pen and paper and gotten the same effect. <br/>

     When I got more into AI I realized that I could use it to automate my task management, and just like that Ari was born. <br/>
