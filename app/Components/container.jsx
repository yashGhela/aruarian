...
// };
  ...
  return (
        ...
        <div className={`  w-full  ${isRes?'h-[300px] md:h-[450px]':'h-[550px]'}  xl:w-1/2 2xl:w-full xl:ml-64 2xl:ml-0 border border-neutral-400/20  bg-white/70 rounded-[30px]  mt-20 lg:mt-0`}>
  <div
