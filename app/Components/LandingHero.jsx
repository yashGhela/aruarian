...
export default function LandingHero(){
    ...
    return(
      ...
      <p className='  mt-8  pb-10 -ml-10   text-transparent bg-clip-text bg-gradient-to-b from-slate-400 via-red-200 to-zinc-300  md:px-32  md:-ml-0 text-8xl   sm:text-8xl  font-bold'>The first ever AI to-do management tool</p>
