...
function Overlay() {
  return (
    <div>
        <motion.div whileHover={{scale:1.05}}    className={`flex z-50 fixed cursor-pointer hover:shadow-inner  top-8 left-8 rounded-full p-1 `}>
...
<path d="M100 22L100 119" stroke="white" stroke-width="10" stroke-linecap="round"/>
      ...
      className=' top-24 left-18 z-10 fixed rounded-xl h-40 w-40 rotate-12 shadow-md'
      src='https://images.unsplash.com/photo-1687716005788-3a31b81f70f8?q=80&w=1948&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'/>
      ...
      <div className='fixed flex bottom-8 z-50 left-8 '>
