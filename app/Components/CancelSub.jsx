...
export default function CancelSub(){
  ...
  ,[])
    ...
    return(
       ...
       <div>
         <motion.button whileHover={{scale:1.05}} onClick={()=>{setShowModal(true)}} className="fixed bottom-8 right-16 text-black/80 hover:text-red-400 px-4 py-2 rounded-full">
