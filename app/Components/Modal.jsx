...
export default function Modal({showModal,setShowModal, children, Header, thin, height}){
    ...
    return(
        <div>
            ...
            <motion.dialog 
            open={showModal}
             className={` rounded-[40px] bg-neutral-400/80  border-2 p-3  backdrop-blur-sm  border-white/[0.06] md:${thin?'md:w-[20%]':'w-[40%]'} md:${modheight} p-5  z-50  fixed inset-1 overflow-auto`}
