  ...
  export default function Dashboard(){
    ...
    return(
        ...
        <header>
         ...
         <main  style={{backgroundImage:'url(https://images.unsplash.com/photo-1700853798321-efc2d2f5aa3b?q=80&w=2074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',backgroundRepeat:'no-repeat'}}  className=' flex text-neutral-100 bg-cover self-center place-content-center bg-neutral-800     text-center p-5 max-w-full min-w-screen  min-h-screen max-h-full overflow-hidden'>
    ...
    {mesSent ?
     ...
     <div className="md:mt-[20%] md:ml-[40%] mt-[90%] ml-10 w-[300px] h-self  backdrop-blur-sm    rounded-[40px] bg-white/20 border p-3  border-white/[0.06]">
    ...
    <p className="text-center text-md font-normal mt-2 p-3 text-white">{responseAI.message}</p>
