...
export default  function PrivacyPolicy(){
    return(
        ...
        <header>
         ...
         <main className=' flex self-center place-content-center  bg-white text-left p-5 max-w-full min-w-screen  min-h-screen max-h-full overflow-hidden'>
...
<h2 className="text-left"><b>PRIVACY POLICY</b></h2>
<p>Effective date: 2024-04-07</p>
<p>1. <b>Introduction</b></p>
<p>Welcome to <b> AruarianAI</b>.</p>
<p><b>AruarianAI</b> (“us”, “we”, or “our”) operates <b>aruarianai.com</b> (hereinafter referred to as <b>“Service”</b>).</p>
<p>Our Privacy Policy governs your visit to <b>aruarianai.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
...
<p><b>SERVICE</b> means the aruarianai.com website operated by AruarianAI.</p>
...
<p>AruarianAI uses the collected data for various purposes:</p>
...
<p>AruarianAI will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
